...
cdef class Rainbow:
    ...
    def __cinit__(self,duelingCategoricalDQN online_net, duelingCategoricalDQN target_net, float beta_priorization_increase = 0.05, float max_epsilon = 1, float min_epsilon = 0.001,
                  ...
                  int batch_size = 128,int threads = 128, int gd_flag = PY_ADAM, int max_buffer_size = 10000, int n_step_rewards = 3, int stop_epsilon_greedy = 500, int epochs_to_copy_target =10,
